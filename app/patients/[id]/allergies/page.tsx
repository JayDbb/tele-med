                    ...
                    <div className="flex items-start gap-4 p-4 rounded-lg border border-dashed border-gray-300 dark:border-gray-600 bg-gray-50/50 dark:bg-gray-800/50">
                      ...
                      <div className="flex-1">
                        <div className="flex justify-between items-center mb-1">
                          <h4 className="text-sm font-bold text-gray-900 dark:text-white">Latex</h4>
                        ...
                        <p className="text-xs text-gray-500 dark:text-gray-400">Reported on May 12, 2024. Reaction: Skin irritation.</p>
                      </div>
                    </div>
                  </div>
                </div>
                  ...
                  <div className="p-5 flex flex-col gap-4">
                    <div className="flex flex-col gap-1.5">
                      ...
                      <div className="relative">
                        ...
                        <input className="w-full pl-9 rounded-lg border-gray-200 dark:border-gray-600 bg-gray-50 dark:bg-gray-800 text-sm focus:ring-primary focus:border-primary transition-shadow text-gray-900 dark:text-white" placeholder="Search (e.g., Shellfish, Aspirin)..." type="text"/>
                      </div>
                    ...
                    <div className="flex flex-col gap-1.5">
                      ...
                      <div className="grid grid-cols-2 gap-2 text-sm">
                        <label className="flex items-center gap-2 cursor-pointer">
                          <input className="rounded border-gray-300 dark:border-gray-600 text-primary focus:ring-primary" type="checkbox"/>
                    ...
                    <div className="grid grid-cols-1 gap-3">
                      <div className="flex flex-col gap-1">
                        ...
                        <input className="rounded-lg border-gray-200 dark:border-gray-600 bg-gray-50 dark:bg-gray-800 text-sm focus:ring-primary focus:border-primary text-gray-600 dark:text-gray-400" type="date"/>
                      </div>
                      <div className="flex flex-col gap-1">
                        <label className="text-xs font-semibold text-gray-700 dark:text-gray-300 uppercase tracking-wider">Additional Notes</label>
                        <textarea className="rounded-lg border-gray-200 dark:border-gray-600 bg-gray-50 dark:bg-gray-800 text-sm focus:ring-primary focus:border-primary resize-none text-gray-900 dark:text-white" placeholder="e.g. Happened when I was a child..." rows={2}></textarea>
                      </div>
                    </div>
                    ...
                    <div className="p-4 flex gap-3">
                      ...
                      <div className="flex-1">
                        ...
                        <div className="flex justify-between items-center mt-1">
                          ...
                          <span className="text-[10px] bg-gray-100 dark:bg-gray-800 px-1.5 py-0.5 rounded text-gray-500 dark:text-gray-400">Not recorded</span>
                        </div>
                      </div>
                    </div>
                    <div className="p-4 flex gap-3">
