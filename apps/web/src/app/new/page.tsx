...
import type { Patient, StructuredTranscriptData } from "../../lib/types";
...
function NewVisitPageContent() {
  ...
  const [transcription, setTranscription] = useState<{
    transcript: string;
    structured: StructuredTranscriptData;
    summary: string;
  } | null>(null);
              ...
              <div className="stack" style={{ gridColumn: "1 / span 2", marginTop: "16px" }}>
                ...
                <details className="stack" style={{ background: "#f9fafb", padding: "16px", borderRadius: "8px" }}>
                  ...
                  <div className="stack" style={{ marginTop: "12px", gap: "12px" }}>
                    ...
                    {transcription.structured.prescriptions && transcription.structured.prescriptions.length > 0 && (
                      <div>
                        <strong>Prescriptions:</strong>
                        <ul style={{ margin: "4px 0 0 20px", padding: 0 }}>
                          {transcription.structured.prescriptions.map((prescription: { medication?: string; dosage?: string; frequency?: string; duration?: string }, idx: number) => (
                            <li key={idx}>
