...
import type { WebKitSpeechRecognition, SpeechRecognitionEvent } from '@/lib/types'
...
export default function PatientNotesPage() {
  ...
  // Macro templates
  const macroTemplates: Record<string, Partial<Record<keyof Note['content'], string>>> = {
    '.dia': {
  ...
  useEffect(() => {
    if ('webkitSpeechRecognition' in window) {
      const recognition = new (window as { webkitSpeechRecognition?: { new (): WebKitSpeechRecognition } }).webkitSpeechRecognition!()
