          ...
          <div className="card stack">
            ...
            {visit.transcripts ? (
              <div className="stack" style={{ gap: "16px" }}>
                ...
                {/* Structured Data */}
                {visit.transcripts.segments?.structured && typeof visit.transcripts.segments.structured === 'object' && (
                  <div className="stack" style={{ gap: "16px" }}>
                    {/* Current Symptoms */}
                          ...
                          <div style={{ overflowX: "auto" }}>
                            <table style={{ width: "100%", borderCollapse: "collapse", background: "#fff", borderRadius: 6 }}>
                              ...
                              <tbody>
                                ...
                                ).map((symptom: { symptom: string; characteristics?: string }, idx: number) => (
                    ...
                    {visit.transcripts.segments.structured.past_medical_history && visit.transcripts.segments.structured.past_medical_history.length > 0 && (
                      <div style={{ background: "#f9fafb", padding: 16, borderRadius: 8, border: "1px solid #e5e7eb" }}>
                        <h3 style={{ margin: "0 0 12px 0", fontSize: "16px", fontWeight: "600", color: "#111827" }}>
                          Past Medical History
                        </h3>
                    ...
                    {/* Treatment Plan */}
                    {visit.transcripts.segments.structured.treatment_plan && visit.transcripts.segments.structured.treatment_plan.length > 0 && (
                    ...
                    {/* Prescriptions */}
                    {visit.transcripts.segments.structured.prescriptions && visit.transcripts.segments.structured.prescriptions.length > 0 && (
                      <div style={{ background: "#fef3c7", padding: 16, borderRadius: 8, border: "1px solid #fde68a" }}>
                        ...
                        <div style={{ overflowX: "auto" }}>
                          <table style={{ width: "100%", borderCollapse: "collapse", background: "#fff", borderRadius: 6 }}>
                            ...
                            <tbody>
                              {visit.transcripts.segments.structured.prescriptions.map((prescription: { medication?: string; dosage?: string; frequency?: string; duration?: string }, idx: number) => (
