...
import type { StructuredTranscriptData } from '@/lib/types'
          ...
          <div className="grid grid-cols-1 lg:grid-cols-2 gap-6">
            ...
            <div className="space-y-6">
              ...
              <div>
                ...
                <div className="space-y-2">
                  {selectedVisitData && 'ros' in selectedVisitData && selectedVisitData.ros ? Object.entries(selectedVisitData.ros).map(([system, finding]) => (
            ...
            <div className="space-y-6">
              ...
              <div>
                ...
                <div className="space-y-2">
                  {selectedVisitData && 'physicalExam' in selectedVisitData && selectedVisitData.physicalExam ? Object.entries(selectedVisitData.physicalExam).map(([system, finding]) => (
                    <div key={system} className="flex gap-3">
                      <span className="text-xs font-medium text-gray-500 dark:text-gray-400 uppercase tracking-wide min-w-[100px]">
                        {system}:
                      </span>
